...
Model.prototype.getByProject = function (obj, cb) {
    if (arguments.length == 1) {
        cb = arguments[0];
        obj = {}
    }
    ...
    var _t = this;
    var projId = +obj.where[0].val1;

    if (!projId) return cb(new MyError('Не передан project id'));

    var o = {
        command: 'get',
        object: 'project_organization',
        params: obj
    };
