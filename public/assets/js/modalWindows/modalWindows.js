/**
 * modalWindows.js - complex cloud solutions, LLC
 *
 * client-side modal windows module. multiple, moveable, collapseable, resizeable.
 */
...
var modalWindow = function(){
    ...
    var mWItem = function(params){
        ...
        this.config_access =    params.config_access || true;
    };

    /**
     * add item to global windows array
     * @param item
     */
    ...
    /**
     * remove instance from global windows array
     * @param instance
     */
...
//        console.log(tryLineWidth / (tryLength+1));
    ...
    mWItem.prototype.render = function(callback){
        var _t = this;
        var isSaveBtn = (_t.hideSaveButton)? '' : '<div class="mw-save-form disabled">Save <span class="ctrl_s">(Ctrl+S)</span></div>';
        var isFullscreenBtn = (_t.hideFullscreen)? '' : '<div class="mw-fullscreen"><i class="fsc-icon"></i><i class="nfsc-icon"></i></div>';

        var config_access = (_t.config_access)? '<div class="mw-config-access"><i class="fa fa-users"></i></div>' : '';
    ...
    /**
     * insert bottom row collapsed form buttons
     */
...
//                console.log('_t.top: ', _t.top, '_t.left: ', _t.left);
    ...
    mWItem.prototype.setHandlers = function(callback){
        ...
        $(document).on('mouseup', function(){
            ...
            _t.wrapper.removeClass('handgrab');
...
//        console.log('MOVE');
    ...
    /**
     * stick window to top/left/right
     * @param callback
     */
