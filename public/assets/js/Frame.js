...
(function () {
	...
	MB.Frame = function (params) {
		...
		this.activeId = (params.ids)? params.ids[0] : null;
     ...
     * @returns {*}
     */
	MB.Frame.prototype.createField = function (field) {
		var _t = this;
		...
		if (field.profile[0]['editable'] || ((_t.activeId !== 'new' && field.profile[0]['updatable']) || (_t.activeId === 'new' && field.profile[0]['insertable']))) {
			...
			switch (typeOfEditor) {
				...
				case 'File':
					...
					break;
				case 'image':
					let img = field.value ? 'upload/' + field.value : '';
					html =
...
//            }
     ...
     * @param callback
     */
// 	MB.Frame.prototype.reloadByActiveId = function(callback){
//
// 		var _t = this;
//
...
// 	};
     ...
     * @param callback
     */
	MB.Frame.prototype.reload = function (callback) {
...
// 				});
     ...
     * @param callback
     */
	MB.Frame.prototype.makeOperation = function (operationName, callback) {
		var _t = this;
		var totalOk = 0;
		var totalErr = 0;
...
// 		}
	 ...
	 * remove form
     */
	MB.Frame.prototype.remove = function(){
