        ...
        populateBlocks: function(callback){
            ...
            var fullHtml =  "<div id='uff-list-container'>" +
                                "<div class='row'>" +
                                    "<div class='col-md-12'>" +
                                        "<div class='toBlockCheckboxes'>" +
                                            "<div class='col-md-6'>" +
                                                "<div class='row lh25'>" +
                                                    "<label class='fn-label'>Search Users</label><input type='text' class='searchUsers fn-control' placeholder='Search'/>" +
                                                "</div>" +
                                            "</div>" +
                                        "</div>" +
                                    "</div>" +
                                    "<div class='col-md-12'>" +
                                        "<div class='toBlockCheckboxes'>" +
                                            "<div class='col-md-6'>" +
                                                "<div class='row'><div class='role-hl'>Available for connection</div>" +
                                                    "<div class='fromBlock'>" +
                                                        "{{#fromUsers}}" +
                                            ...
                                            "</div>" +
                                            "<div class='col-md-6'>" +
                                                "<div class='row'><div class='role-hl'>Connected users</div>" +
                                                    "<div class='toBlock'>" +
                                                        "{{#toUsers}}" +
                            ...
                            "<div class='uff-buttons'>" +
                                "<div class='form-role-slideBack fn-small-btn fn-btn blue'><i class='fa fa-chevron-left'></i> Return</div>" +
                            "</div>";
