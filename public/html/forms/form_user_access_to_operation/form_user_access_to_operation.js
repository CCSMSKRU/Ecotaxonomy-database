(function() {
    ...
    var formInstance = MB.Forms.getForm('form_user_access_to_operation', formID);
    ...
    var access = {
        ...
        populateOperationsTree: function () {
            ...
            holder.on('select_node.jstree', function (e,a) {
                ...
                // formInstance.activeId = id;
                // formInstance.tablePKeys = formInstance.tablePKeys || {'data': []};
                // formInstance.tablePKeys['data'][0] = id;
                //
            ...
            formWrapper.find('.rule-holder input[type="checkbox"][data-id="is_denied"]').off('change').on('change', function(){
                ...
                var o = {
                    ...
                    params: {
                        state: state,
                        user_id: formInstance.activeId,
                        class_operation_id: access.activeNode.id
                    }
                };
