    ...
    tableInstance.ct_instance.ctxMenuData = [
        ...
        },
        {
            ...
            callback: function(){
                ...
                let business_logic_roles = ['TAXONOMY - delete taxa', 'PROJECTS', 'TAXONOMIC TRAITS',
                    'FACTORS', 'MEASUREMENTS', 'SITE ECOTAXONOMY', 'TAXONOMY',
                    'BASIC'];
                ...
                bootbox.dialog({
                    ...
                    buttons:{
                        grant: {
                            label: 'Grant access',// 'Выдать доступ'
                            callback: function(){
                        ...
                        reject: {
                            label: 'Revoke access', //'Отменить доступ'
                            callback: function(){
