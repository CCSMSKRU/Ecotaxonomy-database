(function () {
    ...
    $('.ct-environment-buttons ul').prepend(`<li id="make_access_true" class="ct-environment-btn">
                                            ...
                                            <i class="fa fa-check"></i><div class="btnDoubleInner">Grant access</div></div>
                                            </li>
                                            <li id="make_access_false" class="ct-environment-btn">
                                            <div class="nb btn btnDouble red">
                                            <i class="fa fa-times"></i><div class="btnDoubleInner">Revoke access</div></div>
                                            </li>`);
    ...
    tableInstance.ct_instance.ctxMenuData = [
        {
            name: 'addAccess',
            title: 'Grant access',//Выдать доступ
            disabled: function(){
                return false;
            },
            callback: function(){
        ...
        {
            name: 'removeAccess',
            title: 'Revoke access',//Забрать доступ
            disabled: function(){
                return false;
            },
            callback: function(){
    ...
    var html = '<li style="list-style: none;" class="ct-environment-btn sync_operations"><div class="nb btn btnDouble blue"><i class="fa fa-refresh"></i><div class="btnDoubleInner">Sync operations</div></div></li>';
